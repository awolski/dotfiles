...
** Org Mode
  ...
  (setq org-capture-templates
        '(("t" "Task" entry (file "~/org/refile.org")
          ...
          ("#" "Event" entry (file+olp+datetree "~/org/calendar.org")
           "%i" :immediate-finish t :tree-type week)
...
** Bindings for built-ins
  ...
  #+END_SRC
** Bindings for [[https://github.com/rougier/mu4e-thread-folding][mu4e-thread-folding]]
