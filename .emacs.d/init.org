...
** Org
   ...
   (setq org-todo-keyword-faces
         (quote (("TODO" :foreground "#e76f51" :weight bold)
                 ("NEXT" :foreground "#457b9d" :weight bold)
                 ("DONE" :foreground "#2a9daf" :weight bold)
                 ("WAITING" :foreground "#f4a261" :weight bold)
                 ("HOLD" :foreground "#e9c46a" :weight bold)
                 ("CANCELLED" :foreground "#2a9daf" :weight bold)
                 ("MEETING" :foreground "#2a9daf" :weight bold)
                 ("PHONE" :foreground "#2a9daf" :weight bold))))
   #+end_src
  ...
  (setq org-capture-templates
        '(("t" "Task" entry (file+headline "~/h/org/refile.org" "Refile")
           "* TODO %?\n  %u\n  %a\n" :clock-in t :clock-resume t)
          ("r" "Respond" entry (file+headline "~/h/org/refile.org" "Refile")
           "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
          ("n" "Note" entry (file+headline  "~/h/org/refile.org" "Refile")
           "* %? :NOTE:\n  %U\n  %a\n" :clock-in t :clock-resume t)))
