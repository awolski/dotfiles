...
** Org Mode
   ...
   (setq org-capture-templates
         '(("t" "Task" entry (file "~/org/refile.org")
           ...
           ("dj" "Divorce Journal" entry (file+olp+datetree "~/org/divorce.org" "Journal")
            "* %?\n  %U\n" :tree-type week)
           ("de" "Childcare Emma" table-line (file+olp "~/org/divorce.org" "Childcare" "Emma")
            "|%^T|%^T|||%^{prompt|Both|Bodhi|Eira}||" :table-line-pos "II-1" :kill-buffer t :jump-to-captured t)
           ("dt" "Childcare Tony" table-line (file+olp "~/org/divorce.org" "Childcare" "Tony")
            "|%^T|%^T|||%^{prompt|Both|Bodhi|Eira}||" :table-line-pos "II-1" :kill-buffer t :jump-to-captured t)
